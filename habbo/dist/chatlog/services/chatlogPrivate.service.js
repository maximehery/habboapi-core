...
const chatlogPrivate_entity_1 = require("../entities/chatlogPrivate.entity");
let ChatlogPrivateService = class ChatlogPrivateService {
    constructor(backupService, chatlogPrivateRepository) {
        this.backupService = backupService;
        this.chatlogPrivateRepository = chatlogPrivateRepository;
    }
    getAll(searchOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.chatlogPrivateRepository.findAndCount({
    ...
    getOne(chatlogId, relations) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!chatlogId)
                throw new Error(`invalidParameters`);
            return yield this.chatlogPrivateRepository.findOne({
                where: { id: chatlogId },
                relations: relations
            });
        });
    ...
    delete(chatlogId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!chatlogId)
                throw new Error(`invalidParameters`);
            yield this.chatlogPrivateRepository.delete({ id: chatlogId });
            return true;
        });
    }
    backupAndTruncate() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.backupService.backupMysql('chatlogs_private');
            yield this.chatlogPrivateRepository.clear();
            return true;
        });
    }
};
ChatlogPrivateService = __decorate([
    common_1.Injectable(),
    __param(1, typeorm_1.InjectRepository(chatlogPrivate_entity_1.ChatlogPrivateEntity)),
    __metadata("design:paramtypes", [common_2.BackupService,
        typeorm_2.Repository])
], ChatlogPrivateService);
exports.ChatlogPrivateService = ChatlogPrivateService;
