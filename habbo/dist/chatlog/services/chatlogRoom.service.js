...
const chatlogRoom_entity_1 = require("../entities/chatlogRoom.entity");
let ChatlogRoomService = class ChatlogRoomService {
    constructor(backupService, chatlogRoomRepository) {
        this.backupService = backupService;
        this.chatlogRoomRepository = chatlogRoomRepository;
    }
    getAll(searchOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.chatlogRoomRepository.findAndCount({
    ...
    getOne(chatlogId, relations) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.chatlogRoomRepository.findOne({
                where: { id: chatlogId },
                relations: relations
            });
        });
    ...
    delete(chatlogId) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!chatlogId)
                throw new Error(`invalidParameters`);
            yield this.chatlogRoomRepository.delete({ id: chatlogId });
            return true;
        });
    }
    backupAndTruncate() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.backupService.backupMysql('chatlogs_room');
            yield this.chatlogRoomRepository.clear();
            return true;
        });
    }
};
ChatlogRoomService = __decorate([
    common_1.Injectable(),
    __param(1, typeorm_1.InjectRepository(chatlogRoom_entity_1.ChatlogRoomEntity)),
    __metadata("design:paramtypes", [common_2.BackupService,
        typeorm_2.Repository])
], ChatlogRoomService);
exports.ChatlogRoomService = ChatlogRoomService;
