...
const groupMember_entity_1 = require("../entities/groupMember.entity");
let GroupMemberService = class GroupMemberService {
    constructor(groupMemberRepository) {
    ...
    getAll(searchOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.groupMemberRepository.findAndCount({
    ...
    getOne(groupMembershipId, relations) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!groupMembershipId)
                throw new Error(`invalidParameters`);
            return yield this.groupMemberRepository.findOne({
...
GroupMemberService = __decorate([
    common_1.Injectable(),
    __param(0, typeorm_1.InjectRepository(groupMember_entity_1.GroupMemberEntity)),
