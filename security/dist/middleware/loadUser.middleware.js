...
let LoadUserMiddleware = class LoadUserMiddleware {
    ...
    resolve() {
        return (req, res, next) => {
            ...
            if (!payload)
                throw new common_1.HttpException('invalidToken', common_1.HttpStatus.BAD_REQUEST);
            req.user = payload;
            return next();
        };
    }
};
LoadUserMiddleware = __decorate([
    common_1.Injectable(),
